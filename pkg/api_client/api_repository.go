...
type RepositoryAPI interface {
	...
	*/
	ListRepository(ctx context.Context) ApiListRepositoryRequest

	// ListRepositoryExecute executes the request
	//  @return []RepositoryListItem
	ListRepositoryExecute(r ApiListRepositoryRequest) ([]RepositoryListItem, *http.Response, error)
}
